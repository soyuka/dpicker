...
function DPicker(element) {
  ...
  this._initialize();
  var childs = [this.renderYears(this._events, this._data), this.renderMonths(this._events, this._data)];
  childs.push.apply(childs, this._modulesRender.map(function(e) {
    return e($__2._events, $__2._data);
  }));
  childs.push(this.renderDays(this._events, this._data));
  this._projector = maquette.createProjector();
  this._projector.append(element, this.renderContainer(this._events, this._data, [this.renderInput(this._events, this._data), this.render(this._events, this._data, childs)]));
...
DPicker.prototype._loadModules = function loadModules() {
  ...
  for (var moduleName in DPicker.modules) {
    ...
    if (module.properties) {
      for (var i in module.properties) {
