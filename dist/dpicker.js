...
function DPicker(element) {
  ...
  this._initialize();
  this.mount(element, this.renderContainer(this._events, this._data, [this.renderInput(this._events, this._data), this.render(this._events, this._data, this.getChildrenRender())]));
...
DPicker.prototype.renderDays = injector(function renderDays(events, data, toRender) {
  ...
  var dayActive;
  var loopend = true;
  return DPicker.h('table', [DPicker.h('tr', data.days.map(function(e) {
