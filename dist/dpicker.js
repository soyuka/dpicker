...
var MINUTES = new Array(60).fill(0);
...
DPicker.prototype._parseInputAttributes = function(element) {
  ...
  ;
  ['format', 'min', 'max', 'value', 'time-format'].map(function(e, i) {
...
;
['model', 'format', 'display', 'months', 'days', 'inputName', 'min', 'max', 'time', 'meridiem'].forEach(function(e) {
