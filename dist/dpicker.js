...
DPicker.prototype.renderDays = injector(function renderDays(events, data, toRender) {
  ...
  var day;
  var dayActive;
  return h('table', [h('tr', moment.weekdaysShort().map(function(e) {
    return h('th', e);
...
;
['model', 'format', 'display', 'futureYear', 'pastYear', 'months', 'inputName'].forEach(function(e) {
