...
},{"../dpicker.moment.js":8}],10:[function(require,module,exports){
'use strict';
var DPicker = require('../dpicker.moment.js');
...
},{"../dpicker.moment.js":8}],11:[function(require,module,exports){
'use strict';
var DPicker = require('../dpicker.moment.js');
...
},{"../dpicker.moment.js":8}],12:[function(require,module,exports){
'use strict';
var _appendChild = require('yo-yoify/lib/appendChild');
var DPicker = require('../dpicker.moment.js');
    ...
    if (data.concatHoursAndMinutes) {
        ...
        selects.push((_select = document.createElement('select'), _select.onchange = events.minuteHoursChange, _select.setAttribute('name', 'dpicker-time'), _select.setAttribute('aria-label', 'time'), _appendChild(_select, [
            ...
            [].concat.apply([], minutes.map(function (minute) {
                ...
                return _this.setSelected((_option = document.createElement('option'), _option.setAttribute('value', '' + String(value) + ''), _appendChild(_option, [text]), _option), value === modelStringValue);
            }),
            ' '
        ]), _select));
    } else {
        ...
        selects.push((_select2 = document.createElement('select'), _select2.onchange = events.hoursChange, _select2.setAttribute('name', 'dpicker-hours'), _select2.setAttribute('aria-label', 'Hours'), _appendChild(_select2, [hours.map(function (e, i) {
                var _option2;
                return _this.setSelected((_option2 = document.createElement('option'), _option2.setAttribute('value', '' + String(e) + ''), _appendChild(_option2, [padLeftZero(e)]), _option2), e === modelHours);
                ...
                var _option3;
                return _this.setSelected((_option3 = document.createElement('option'), _option3.setAttribute('value', '' + String(e) + ''), _appendChild(_option3, [padLeftZero(e)]), _option3), e === modelMinutes);
            })]), _select3));
    }
    if (data.meridiem !== false) {
        var _select4;
        ...
        selects.push((_select4 = document.createElement('select'), _select4.onchange = events.meridiemChange, _select4.setAttribute('name', 'dpicker-meridiem'), _appendChild(_select4, [
            ...
            MERIDIEM_TOKENS.map(function (e) {
                var _option4;
                return _this.setSelected((_option4 = document.createElement('option'), _option4.setAttribute('value', '' + String(e) + ''), _appendChild(_option4, [e]), _option4), modelMeridiem === e);
            }),
            ' '
        ]), _select4));
    }
...
module.exports = DPicker;
},{"../dpicker.moment.js":8,"yo-yoify/lib/appendChild":4}]},{},[6])(6)
});