...
var renderTime = function renderTime(events, data, toRender) {
    ...
    var _getHoursMinutes = getHoursMinutes(data), hours = _getHoursMinutes.hours, minutes = _getHoursMinutes.minutes;
...
DPicker.prototype._minutesStep = function () {
    ...
    var _getHoursMinutes2 = getHoursMinutes(this._data), hours = _getHoursMinutes2.hours, minutes = _getHoursMinutes2.minutes;
    var modelMinutes = this._data.model.minutes();
    if (minutes.length === 0) {
        this._data.min.minutes(0);
        this._data.min.add(1, 'hours');
        var _getHoursMinutes3 = getHoursMinutes(this._data), _hours = _getHoursMinutes3.hours, _minutes = _getHoursMinutes3.minutes;
    }
